...
from tensorflow.keras.applications import ResNet50, VGG16, MobileNet, MobileNetV2, DenseNet201, NASNetMobile, InceptionV3, InceptionResNetV2
...
class TransferLearningModel(BaseModel):
    ...
    def _build_transfer_learning_model(self):
        ...
        self.model = NASNetMobile(weights='imagenet', input_tensor=input, include_top=False, input_shape=(224, 224, 3))
